...
import { PRECISION_18, PRECISION_6, PRECISION_2 } from "./constants.js";
...
export function safeDateFromSeconds(
...
export function mapLimit(limit: any) {
  return {
    ...
    takeProfitPrice:
      limit.takeProfitPrice !== undefined
        ? normalize(limit.takeProfitPrice, 18)
        : null,
    stopLossPrice:
      limit.stopLossPrice !== undefined
        ? normalize(limit.stopLossPrice, 18)
        : null,
...
export function mapPosition(pos: any) {
  return {
    ...
    stopLossPrice:
      pos.stopLossPrice !== undefined ? normalize(pos.stopLossPrice, 18) : null,
    takeProfitPrice:
      pos.takeProfitPrice !== undefined
        ? normalize(pos.takeProfitPrice, 18)
        : null,
...
export function mapPair(pair: any) {
  return {
    ...
    maxLeverage: normalize(pair.maxLeverage, 2),
    ...
    overnightMaxLeverage:
      parseInt(pair.overnightMaxLeverage) !== 0
